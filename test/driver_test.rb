...
describe "Driver class" do
  describe "Driver instantiation" do
    ...
    it "throws an ArgumentError with a bad id number" do
      expect { RideShare::Driver.new(id: 0, name: "George", vin: "33133313331333133") }.must_raise ArgumentError
    end
    
    it "throws an ArgumentError with a bad VIN value" do
  ...
  describe "total_revenue" do
    it "verifies the total revenue for each driver" do
      # populates driver and trip instances
      ...
      all_trips.each do |trip|
        if trip.cost != nil && trip.driver_id == 3
          ...
          cost -= 1.65
          if cost > 0
            total_revenue_for_ride = (cost * 0.8).round(2)
          else
            total_revenue_for_ride += cost
          end
          total_revenue_by_driver += total_revenue_for_ride
        end 
      end
