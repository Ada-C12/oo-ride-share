...
describe "TripDispatcher class" do
  ...
  describe "request trip" do
    ...
    it "Will automatically assign the first available driver to the trip who has had no trips or the longest time between trips" do
      dispatcher = build_test_dispatcher
      
      trip = dispatcher.request_trip(8)
      
      expect(trip.driver_id).must_equal 3
    ...
    it "will add the in progress trip to driver trips" do
      ...
      before_count = dispatcher.drivers[2].trips.length
      trip = dispatcher.request_trip(8)
      after_count = dispatcher.drivers[2].trips.length
